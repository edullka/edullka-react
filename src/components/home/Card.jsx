...
const Card = (props) => {
  ...
  return (
    <div className={"flex-col col-span-2 border " + (props.disabled ? "border-gray-300 opacity-60" : "border-gray-200") + " shadow-xl dark:border-transparent dark:bg-gray-900 rounded-xl"}>
      <div className="relative flex items-center justify-center w-full bg-gray-200 rounded-b-none dark:bg-gray-700 rounded-xl h-60">
